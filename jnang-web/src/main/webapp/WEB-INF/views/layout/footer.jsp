	...
	<div class='foot_sc1'>
		<div class='con_bx'>
				...
				<ul class='cp1'>
					<li class='dp1'>
						...
						<div class='copy1'>
							...
							TEL : 02-3422-4831~4 / FAX : 02-3422-4848<br>
					...
					<li class='dp1'>
						<div class='bx_gov1'>
							<div class='ly_gov1'>
								...
								<img src='${pageContext.request.contextPath}/resource/images/common/bn_copyright_a_01.png' alt='국민의 내일을 위한 정보혁신 보다나은 정부'>
								</a>
							</div>
						</div>
					</li>
			...
			<div class='clbx'>
				<div class='cp2'>
					<ul>
						<li><img src='${pageContext.request.contextPath}/resource/images/common/bn_copyright_b_01.jpg' alt='2017노사문화우수기업'></li>
						<li><img src='${pageContext.request.contextPath}/resource/images/common/bn_copyright_b_02.jpg' alt='한국서비스품질우수기업'></li>
						<li><img src='${pageContext.request.contextPath}/resource/images/common/bn_copyright_b_03.jpg' alt='인적자원개발우수기관'></li>
						<li><img src='${pageContext.request.contextPath}/resource/images/common/bn_copyright_b_04.jpg' alt='가족친화우수기관'></li>
					</ul>
				</div>
			</div>
		</div>
