...
<div class='sub_useinfo01'>
	...
	<div class='clbx'>
		<ul class='tab_ty1_cnt_4a jsc_tab1a_btn'>
			...
			<li><a href='javascript:;'>운영시간</a></li>
			<li><a href='javascript:;'>이용약관</a></li>
			<li><a href='javascript:;'>주차장이용</a></li>
		</ul>
	</div>
	...
	<div class='jsc_tab1a_con'>
		...
		<div class='autoscroll_x1 margin_top_1dot0'>
			...
			<tr>
				<td rowspan="3" class="border_r1">방문접수</td>
				<td>기존회원</td>
			...
			<tr>
				<td rowspan="2" class="border_r1">인터넷접수</td>
				<td>기존회원</td>
	...
	<div class='jsc_tab1a_con'>
		...
		<div class='bg_icon_round_green1a05 fontsize_1dot30 padding_left_1dot0'>접수방법</div>
		<div class='autoscroll_x1 margin_top_1dot0'>
			<table class='stbl_l1a con_tbl1' summary='이 표는 구분/접수기간/방문접수시간/인터넷접수시간 정보로 구성되어 있습니다.'>
			<caption>접수방법</caption>
			<tr>
				<th>구분</th>
				<th>접수절차</th>
				<th>비고</th>				
			...
			<tr>
				<td>방문접수</td>
				<td class='ali_l'>직접방문 -> 강좌선택 -> 신청서작성 -> 회원가입 접수 -> 회원등록회원등록 신청서(센터비치), 신분증, 수강료</td>
				<td>-</td>				
			</tr>
			<tr>
				<td>인터넷접수</td>
				<td class='ali_l'>회원가입 및 로그인 -> 중랑문화체육관 수강신청 클릭 -> 개강시 중랑문화체육관 1층 안내데스크에서 회원카드 수령 후 이용</td>
				<td>-</td>				
			</tr>                        
			</table>
		</div>
	...
	<div class='jsc_tab1a_con'>
		...
		<div class='bg_icon_round_green1a05 fontsize_1dot30 padding_left_1dot0'>수영</div>
		...
		<div class='autoscroll_x1 margin_top_1dot0'>
			...
			<tr>
				<td rowspan="2" class="border_r1">평일(월~금)</td>
				<td>월, 수, 금</td>
				<td>1부 / 08:00~08:50</td>
				<td rowspan="2">
				성인 3,700<br>
				중고생 2,700<br>
				어린이 2,200
				</td>
				<td>월, 수, 금<br>1개 레인사용<br>평영 이상자, 어린이 입장불가</td>
			</tr>
			<tr>
				
				<td>화, 목</td>
				<td>2부 / 13:00~13:50</td>				
				<td>유아풀 6레인 사용<br>어린이 입장 가능</td>
			</tr>
			<tr>
				<td>토요일</td>				
				<td colspan="2">
				...
				<td rowspan="2">
				※ 단, 토요일 1부는 성인만 입장가능<br>(자유형 이상자, 2개 레인 사용)<br><br>
				※ 물놀이 튜브 및 구명조끼, 오리발 사용금지
				</td>
			</tr>
			<tr>
				<td>일요일</td>				
		...
		<div class='autoscroll_x1 margin_top_1dot0'>
			...
			<tr>
				...
				<td rowspan='2'>개인운동복 수건, 실내용운동화,<br>휴일 개별운동</td>
			</tr>
			<tr>
				<td>일요일</td>
				<td>09:00~16:50</td>
		...
		<div class='margin_top_0dot5 lineheight_1dot8'>
			매월 2,4,5주 일요일 및 법정공휴일
		</div>

		<br>
		<br>

		<div class='bg_icon_round_green1a05 fontsize_1dot30 padding_left_1dot0'>체육관</div>
		...
		<div class='autoscroll_x1 margin_top_1dot0'>
			...
			<tr>
				<th colspan="2">구분</th>				
				<th colspan="2">시간 및 요일</th>				
				<th>회비(원)</th>
				<th>유의사항</th>
			</tr>
			<tr>
				<td rowspan="4" class="border_r1">배드민턴</td>
				<td rowspan="2" class="border_r1">A</td>
				<td>06:00~07:50</td>
				<td>월~금</td>
				<td>2,400</td>
				<td rowspan="4" class='ali_l'>
					<ul class='ul_hyphen1a13'>
						<li>성인만 입장가능</li>
						<li>실내용운동화 및 개인라켓지참</li>
					</ul>
				</td>
			</tr>
			<tr>						
			...
			<tr>				
				<td rowspan="2" class="border_r1">B</td>
				<td>20:00~21:50</td>
				<td>월~금</td>
				<td>2,400</td>							
			</tr>
	...
	<!-- 운영시간 -->
	<div class='jsc_tab1a_con'>
		<div class='bg_icon_circle_green1a fontsize_1dot60 padding_left_1dot5'>운영시간안내</div>
		<br>
		<br>
		<div class='bg_icon_round_green1a05 fontsize_1dot30 padding_left_1dot0'>운영시간</div>
		<div class='autoscroll_x1 margin_top_1dot0'>
			<table class='stbl_l1a con_tbl1' summary='이 표는 구분/접수기간/방문접수시간/인터넷접수시간 정보로 구성되어 있습니다.'>
			<caption>운영시간</caption>
			<tr>
				<th>구분</th>
				<th>평일(월~금)</th>
				<th>토</th>
			...
			<tr>
				...
				<td>06:00 ~ 21:50</td>
				<td>06:00 ~ 20:20</td>
				<td>09:30 ~ 17:30(1,3주)</td>
			</tr>
			<tr>
				<td>헬스장</td>
				<td>06:00 ~ 21:50</td>
				<td>06:00 ~ 20:50</td>
				<td>09:00 ~ 16:50(1,3주)</td>
			</tr>
                        <tr>
				<td>대체육관</td>
				<td>06:00 ~ 21:50</td>
		...
		<div class='margin_top_0dot5 lineheight_1dot8'>		
			<span class='fc_orange1'>※ 휴관일 : 매월 2,4,5주 일요일 및 법정공휴일</span>
		</div>		
	</div>
	...
	<!-- 주차장이용 -->
	<div class='jsc_tab1a_con'>
		<div class='bg_icon_circle_green1a fontsize_1dot60 padding_left_1dot5'>주차장이용 안내</div>
		<br>
		<br>
		<div class='bg_icon_round_green1a05 fontsize_1dot30 padding_left_1dot0'>번호인식 주차관제 시스템 도입</div>
		<div class='autoscroll_x1 margin_top_1dot0'>
			<table class='stbl_l1a con_tbl1' summary='이 표는 구분/접수기간/방문접수시간/인터넷접수시간 정보로 구성되어 있습니다.'>
			<caption>주차장이용</caption>
			<tr>
				<th>회원</th>
				<th>비회원</th>
			</tr>
			<tr>
				<td>회원에 한하여 3시간 이내 무료주차 이용<br>(단, 초과시 10분당 200원의 요금부과)</td>
				<td>10분당 200원</td>		
			</tr>
			</table>
		</div>
		<div class='margin_top_0dot5 lineheight_1dot8'>		
			<span class='fc_orange1'>※ 접수 시 안내데스크에 차량번호를 꼭 등록해주세요.</span>
		</div>		
	</div>
