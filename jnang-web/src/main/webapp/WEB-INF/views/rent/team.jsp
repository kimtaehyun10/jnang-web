	  ...
	  <td colspan="4" align="left">
	  	...
	  	<div id="mem_list">
			<c:forEach items="${teamMemList}" var="result" varStatus="status">
				...
				주소 : <span style='margin:0px 5phpx 0 5px;display:inline-block; width:300px; border: none;' class='ali_c'><input type='text' id='addr${status.count}' value='${result.mem_addr}' name='uaddr' style='width:100%;' onclick='execDaumPostcode(document.getElementById("zip"), document.getElementById("addr${status.count}"));'></span>
