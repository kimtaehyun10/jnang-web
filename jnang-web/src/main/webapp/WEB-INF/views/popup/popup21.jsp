...
.popups_footer button {margin-right:5px;padding:5px 10px;border:0;background:#393939;color:#fff}
 ...
 <body>
  <div id="popdiv">
	...
	<div id="popups_20" class="popups">
		<div class="popups_con" style="cursor:pointer">
			<img src="/resource/images/popup/popup21.png" title="코로나바이러스 휴관안내" alt="코로나바이러스 휴관안내" />
			<map name="Map">
		...
		<div class="popups_footer">
			<button class="popups_reject popups_20">오늘은 다시 열람하지 않습니다.</button>
			<button class="popups_close popups_20">닫기</button>
		</div>
	</div>
